...
class PA_CW_AlmacenDigital():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_AlmacenDigital'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Almacén digital"
    ...
    def check(self):
        ...
        keys_to_check = ["No permitir que se ejecute el Almacén digital"]
