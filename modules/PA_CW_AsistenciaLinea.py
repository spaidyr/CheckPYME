...
class PA_CW_AsistenciaLinea():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_AsistenciaLinea'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Asistencia en línea"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar la ayuda activa"]
