...
class PA_CW_Autocompletar():
    ...
    def __init__(self) -> dict:
        ...
        self.result = {}
        name = 'PA_CW_Autocompletar'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Internet Explorer/Configuración de Internet/Autocompletar"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar las sugerencias de direcciones URL"]
