...
class PA_CW_ContenidoNube():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_ContenidoNube'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Contenido de la nube"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar experiencias del consumidor de Microsoft", 
                         "No mostrar recomendaciones de Windows"]
