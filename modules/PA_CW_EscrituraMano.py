...
class PA_CW_EscrituraMano():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_EscrituraMano'
        self.result['module_name'] = name
        self.result['policy_name'] = "Panel de control/Configuración regional y de idioma/Personalización de escritura a mano"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar el aprendizaje automático"]
