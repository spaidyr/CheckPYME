...
class PA_CW_HistorialExplor():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_HistorialExplor'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Internet Explorer/Eliminar el historial de exploración"
    ...
    def check(self):
        ...
        keys_to_check = ["Evitar la eliminación de datos de filtrado ActiveX, protección de rastreo y No realizar seguimiento",
                        "Impedir que se elimine el historial de descarga",
                        "Impedir que se eliminen contraseñas",
                        "Impedir que se eliminen cookies",
                        "Impedir que se eliminen datos del sitio de favoritos",
                        "Impedir que se eliminen los archivos temporales de Internet",
                        "Impedir que se eliminen los datos de filtrado InPrivate",
                        "Impedir que se eliminen los datos de formularios",
                        "Impedir que se eliminen los sitios web que el usuario visitó",
                        "Permitir que se elimine el historial de exploración al salir"]
