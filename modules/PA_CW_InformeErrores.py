...
class PA_CW_InformeErrores():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_InformeErrores'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Informe de errores de Windows"
    ...
    def check(self):
        ...
        keys_to_check = ["Deshabilitar el informe de errores de Windows", 
