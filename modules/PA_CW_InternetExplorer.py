...
class PA_CW_InternetExplorer():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_InternetExplorer'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Internet Explorer"
    ...
    def check(self):
        ...
        keys_to_check = ["Activar Sitios sugeridos", 
                         "Impedir administración del filtro SmartScreen",
                         "Permitir a los servicios de Microsoft ofrecer sugerencias mejoradas mientras el usuario escribe en la barra de direcciones"]
