...
class PA_CW_MicrosoftDefender():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_MicrosoftDefender'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Antivirus de Microsoft Defender"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar Antivirus de Microsoft Defender"]
