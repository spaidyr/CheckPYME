...
class PA_CW_RecopilDatos():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_RecopilDatos'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Recopilación de datos y compilaciones preliminares"
    ...
    def check(self):
        ...
        keys_to_check = ["No volver a mostrar notificaciones de comentarios",
                         "Permitir telemetría"]
