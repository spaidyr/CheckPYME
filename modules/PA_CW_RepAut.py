...
class PA_CW_RepAut():
    ...
    def __init__(self) -> dict:
        ...
        self.result['policy_name'] = "Componentes de Windows/Directivas de Reproducción automática"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar Reproducción automática", 
                         "Desactivar Reproducción automática en:",
                         "Establece el comportamiento predeterminado para ejecución automática.",
                         "Comportamiento predeterminado de ejecución automática"]
