...
class PA_CW_SessionWindows():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_SessionWindows'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Opciones de inicio de sesión de Windows"
    ...
    def check(self):
        ...
        keys_to_check = ["Informar cuando el servidor de inicio de sesión no está disponible durante el inicio de sesión del usuario",
                         "Mostrar información acerca de inicios de sesión anteriores durante inicio de sesión de usuario"]
