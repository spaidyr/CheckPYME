...
class PA_CW_ShellRemota():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_ShellRemota'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Shell remoto de Windows"
    ...
    def check(self):
        ...
        keys_to_check = ["Permitir acceso a shell remoto"]
