...
class PA_CW_SmartScreenExplorador():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_SmartScreenExplorador'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/SmartScreen de Windows Defender/Explorador"
    ...
    def check(self):
        ...
        keys_to_check = ["Configurar SmartScreen de Windows Defender", 
