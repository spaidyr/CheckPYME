...
class PA_CW_Tienda():
    ...
    def __init__(self) -> dict:
        ...
        self.result['policy_name'] = "Componentes de Windows/Tienda"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar la aplicación Store",
                         "Deshabilitar todas las aplicaciones de Microsoft Store "]
