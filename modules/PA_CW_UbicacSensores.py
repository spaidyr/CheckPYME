...
class PA_CW_UbicacSensores():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_UbicacSensores'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Ubicación y sensores"
    ...
    def check(self):
        ...
        keys_to_check = ["Desactivar scripting de ubicación",
                         "Desactivar sensores",
