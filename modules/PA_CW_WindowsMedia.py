...
class PA_CW_WindowsMedia():

    def __init__(self) -> dict:

        self.result = {}
        name = 'PA_CW_WindowsMedia'
        self.result['module_name'] = name
        self.result['policy_name'] = "Componentes de Windows/Administración de derechos digitales de Windows Media"
    ...
    def check(self):
        ...
        keys_to_check = ["Impedir el acceso a Internet de Windows Media DRM"]
